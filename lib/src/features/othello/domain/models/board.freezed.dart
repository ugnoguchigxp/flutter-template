...
/// @nodoc
mixin _$Board {
  List<List<Player>> get cells => throw _privateConstructorUsedError;
...
abstract class $BoardCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<List<Player>> cells});
}
...
class _$BoardImpl extends _Board {
  const _$BoardImpl({final List<List<Player>> cells = const []})
    : _cells = cells,
      super._();
...
abstract class _Board extends Board {
  const factory _Board({final List<List<Player>> cells}) = _$BoardImpl;
